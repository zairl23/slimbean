    ...
    <div class="container-fluid">
        <!-- <div class="row"> -->
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <a title="增加工序" href="./addProcess"><span class="glyphicon glyphicon-plus"></span></a>
                        ...
                        <tbody>
                            <?php foreach ($processes as $process) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a id="edit" href=<?php echo "./editProcess/" . $process['id']; ?> name="edit" class="btn btn-success">编辑</a>
                                    <!-- <a id="deleteUser" onClick="if(confirm('您确定删除此条消息么?')) {window.location='./deleteProcess/'+ <?php echo $process['id']; ?>;} else {return false;}" name="删除" class="btn btn-danger">删除</a> -->
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
