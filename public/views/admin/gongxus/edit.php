	...
	<div class="container-fluid">
		<!-- <div class="row"> -->
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<select id="selectbasic" name="follow_id" class="form-control">
						<option value="0">请选择</option>
						<?php foreach ($roles as $role) : ?>
							<?php if($role->id == $gongxu['follow_id']) :?>
								<?php echo "<option  selected='selected' value=". $role['id'] . ">" . $role['name'] . "</option>";?>
							<?php else :?>
								<?php echo "<option value=". $role['id'] . ">" . $role['name'] . "</option>";?>
							<?php endif;?>
				...
				<!-- Text input-->
				<div class="control-group">
				  <label class="control-label" for="desc">工序描述</label>
				  <div class="controls">
					<input id="name" name="desc" type="text" placeholder="工序描述"  value="<?php echo $gongxu['desc']; ?>" class="form-control input-xxlarge" required="">
				  </div>
				</div>
