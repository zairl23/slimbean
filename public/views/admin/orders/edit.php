		...
		<!-- <div class="row"> -->
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li class="<?php echo $orderActive; ?>"><a href="<?php echo $adminUrl;?>">订单列表</a></li>
					<!-- <li><a href="#">Reports</a></li>
					<li><a href="#">Analytics</a></li>
					<li><a href="#">Export</a></li> -->
				</ul>
				<ul class="nav nav-sidebar">
					<li class="<?php echo $userActive; ?>"><a href="../users">员工列表</a></li>
				...
				<ul class="nav nav-sidebar">
					<li class="<?php echo $processActive; ?>"><a href="../processes">工序列表</a></li>
				   <!--  <li><a href="">One more nav</a></li>
					<li><a href="">Another nav item</a></li> -->
				</ul>
			</div>
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input id="order_number" name="order_number" type="text" placeholder="工单单号" class="input-xxlarge" required="" value="<?php echo $order['order_number'];?>">
				  </div>
				</div>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input id="costumer" name="costumer_name" type="text" placeholder="客户名称" class="input-xxlarge" required="" value="<?php echo $order['costumer_name'];?>">
